...
if (!fs.existsSync(standardFontDataUrl)) {
    console.warn(`Standard fonts directory not found at: ${standardFontDataUrl}`);
}
...
const extractTextFromPDF = (fileKey) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const pdfDocument = yield (0, pdfjs_dist_1.getDocument)({
            data: fileBuffer,
